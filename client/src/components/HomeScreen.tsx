...
export default function HomeScreen() {
  ...
  const [mode, setMode] = useState<"browse" | "join">(codeFromUrl ? "join" : "browse");
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 min-h-screen">
      ...
      {mode === "join" ? (
        <div className="max-w-sm mx-auto space-y-3">
          <input
            type="text"
            placeholder="Room Code (e.g. XJYK)"
            value={roomCode}
            onChange={(e) => {
            ...
            maxLength={4}
            className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 text-center text-2xl tracking-[0.3em] font-mono"
          />
          <button
            onClick={handleJoin}
